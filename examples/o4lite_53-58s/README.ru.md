...
**Крен.** Не трогается: дефект крена на этом блоке не измерен (расхождение крена
телеметрии и картинки выше 4 Гц на уровне чистых клипов), крен оставлен ровно
как записал DJI; дрожание 0.038 °/кадр при пороге картинки 0.034.
